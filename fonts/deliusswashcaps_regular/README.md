...
import (
  ...
  _ "github.com/gmlewis/go-fonts-d/fonts/deliusswashcaps_regular"
)

func main() {
  // ...
  xPos, yPos, xScale, yScale := 0.0, 0.0, 1.0, 1.0
  message := "Sample from deliusswashcaps_regular"
  render, err := fonts.Text(xPos, yPos, xScale, yScale, message, "deliusswashcaps_regular", &fonts.Center)
  if err != nil {
    log.Fatal(err)
  }
