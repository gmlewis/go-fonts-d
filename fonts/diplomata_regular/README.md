...
import (
  ...
  _ "github.com/gmlewis/go-fonts-d/fonts/diplomata_regular"
)

func main() {
  // ...
  xPos, yPos, xScale, yScale := 0.0, 0.0, 1.0, 1.0
  message := "Sample from diplomata_regular"
  render, err := fonts.Text(xPos, yPos, xScale, yScale, message, "diplomata_regular", &fonts.Center)
  if err != nil {
    log.Fatal(err)
  }
