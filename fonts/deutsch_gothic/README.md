...
import (
  ...
  _ "github.com/gmlewis/go-fonts-d/fonts/deutsch_gothic"
)

func main() {
  // ...
  xPos, yPos, xScale, yScale := 0.0, 0.0, 1.0, 1.0
  message := "Sample from deutsch_gothic"
  render, err := fonts.Text(xPos, yPos, xScale, yScale, message, "deutsch_gothic", &fonts.Center)
  if err != nil {
    log.Fatal(err)
  }
