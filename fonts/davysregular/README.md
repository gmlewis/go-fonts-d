...
import (
  ...
  _ "github.com/gmlewis/go-fonts-d/fonts/davysregular"
)

func main() {
  // ...
  xPos, yPos, xScale, yScale := 0.0, 0.0, 1.0, 1.0
  message := "Sample from davysregular"
  render, err := fonts.Text(xPos, yPos, xScale, yScale, message, "davysregular", &fonts.Center)
  if err != nil {
    log.Fatal(err)
  }
